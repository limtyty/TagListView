...
open class TagListView: UIView {
  ...
  open override func prepareForInterfaceBuilder() {
    addTag("Welcome",image: nil)
    addTag("to",image: nil)
    addTag("TagListView",image: nil).isSelected = true
  }
  ...
  private func createNewTagView(_ title: String, image: UIImage?) -> TagView {
  ...
  @discardableResult
  open func addTag(_ title: String, image: UIImage?) -> TagView {
    defer { rearrangeViews() }
    return addTagView(createNewTagView(title,image: image))
  }

  @discardableResult
  open func addTags(_ titles: [String],image: UIImage?) -> [TagView] {
    return addTagViews(titles.map({ title in
      createNewTagView(title, image: image)
    }))
  }
  ...
  @discardableResult
  open func insertTag(_ title: String, image: UIImage?,at index: Int) -> TagView {
    return insertTagView(createNewTagView(title,image: image), at: index)
  }
